{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNkhjrrNQs+J3a4bvg6Mu/7",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/usmangul23/Unit-Conversion/blob/main/unit_conversion_tool_v1.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        ...
        "\n",
        "# Streamlit app\n",
        "st.title(\"Imperial and Metric Unit Conversion Tool\")\n",
        "\n",
        "# Select conversion type\n",
        "conversion_type = st.selectbox(\"Select conversion type\",\n",
        "                               [\"Length\", \"Weight\", \"Pressure\", \"Temperature\", \"Volume\"])\n",
        "\n",
        ...
        "    # Volume conversion\n",
        "    volume_unit = st.selectbox(\"Select unit\", [\"Liters to Gallons\", \"Gallons to Liters\"])\n",
        "    volume_value = st.number_input(\"Enter the value\", format=\"%.2f\")\n",
        "\n",
        "    if st.button(\"Convert\"):\n",
        "        if volume_unit == \"Liters to Gallons\":\n",
        "            result = liters_to_gallons(volume_value)\n",
        "            st.write(f\"{volume_value} liters is equal to {result} gallons.\")\n",
        "        else:\n",
        "            result = gallons_to_liters(volume_value)\n",
        "            st.write(f\"{volume_value} gallons is equal to {result} liters.\")\n"
      ]
    }
  ]
}